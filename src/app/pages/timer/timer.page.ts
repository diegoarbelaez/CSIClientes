...
export class TimerPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.loadFilesFirstTime(); //Cuando se inicia se carga por primera vez el método, que crea el directorio o lee de él
  ...
  //Este método ingresa al directorio y lo crea si no existe
  ...
  //Elimina el archivo para que cuando ingrese no lo cargue nuevamente
